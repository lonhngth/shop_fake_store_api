  ...
  return (
    ...
    >
      <div className="flex items-center justify-between py-6 border-b">
        ...
        <div
          onClick={handleClose}
          className="cursor-pointer w-8 h-8 flex justify-center items-center hover:opacity-50 transition"
        >
          <IoMdArrowForward className="text-2xl" />
        </div>
      </div>
      <div
        className="flex flex-col gap-y-2 h-[420px] 
      ...
      <div className="flex flex-col gap-y-3 py-4 mt-4">
        <div className="flex w-full justify-between items-center">
          ...
          <div
            ...
            className="cursor-pointer py-4 bg-red-500 text-white 
                      w-12 h-12 flex justify-center items-center hover:opacity-50 transition"
          >
            <FiTrash2 />
          </div>
        </div>
        <Link
          ...
          className="bg-gray-200 flex p-4 justify-center items-center
                   text-primary w-full font-medium hover:opacity-50 transition"
        >
          View cart
        </Link>
        <Link
          ...
          className="bg-primary flex p-4 justify-center items-center
                   text-white w-full font-medium hover:opacity-50 transition"
        >
          Checkout
        </Link>
      </div>
